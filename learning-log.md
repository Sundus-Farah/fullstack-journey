# Learning Log
 ...
 June 30, 2026
- Created GitHub repo and README
 
 July 4, 2026
- Officially started IBM Full Stack Software Developer Professional Certificate
- Course 1: Introduction to Software Engineering
- Completed Module 1: What is Software Engineering?
- Learned: definition of software engineering, types of software, 
  overview of the Software Development Lifecycle (SDLC)

 July 5, 2026
- Course 1: Introduction to Software Engineering
- Completed: Software Development Methodologies (Waterfall, Agile, Scrum)
- Completed: Software Versions and Releases
- Key takeaway: Agile breaks work into sprints for flexibility; 
  Waterfall is sequential and rigid — most modern teams use Agile

  
 July 6, 2026
- Course 1: Introduction to Software Engineering
- Completed Module 1 fully ✅
- Topics covered across Module 1:
